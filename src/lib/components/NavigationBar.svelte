<script lang="ts">
    ...
    let workspaceRowEl: HTMLElement | null = null;
    let spacerEl: HTMLElement | null = null;
    let navActionsEl: HTMLElement | null = null;
    let authContainerEl: HTMLElement | null = null;
    let settingsContainerEl: HTMLElement | null = null;
...
<div class="nav" bind:this={navEl}>
    ...
    <div class="workspace-row" bind:this={workspaceRowEl}>
        <div
    ...
    <div class="spacer" bind:this={spacerEl}></div>

    <div class="nav-actions" bind:this={navActionsEl}>
        <div class="auth-container" bind:this={authContainerEl}>
            <button 
                class="auth-btn"
                on:click={isLoggedIn ? onLogout : onShowLoginModal}
        ...
        <div class="settings-container" bind:this={settingsContainerEl}>
            <button 
                class="settings-btn"
